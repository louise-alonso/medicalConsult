...
public class SecurityConfig {
    ...
    public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception {
        ...
        auth.inMemoryAuthentication()
                .withUser("Louise").password(passwordEncoder.encode("12345")).roles("ADMIN")
                .and()
                .withUser("Luiz").password(passwordEncoder.encode("98765")).roles("PACIENTE")
                .and()
                .withUser("Josefa").password(passwordEncoder.encode("121212")).roles("SECRETARIA");
